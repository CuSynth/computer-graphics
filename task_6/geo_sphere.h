    ...
    public renderable
{
    ...
    QOpenGLTexture* texture_night_ = nullptr;
...
public:
    ...
    geo_sphere(size_t subgrid_count_x = 100, size_t subgrid_count_y = 100, const QColor& color = { 255,255,255 }, const QVector3D& position = {}, const QVector3D& rotation = {}, float angle = 0.0f);
    geo_sphere(const geo_sphere& other) = default;
    virtual ~geo_sphere() = default;
};
