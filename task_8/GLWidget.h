...
class GLWidget : public QOpenGLWidget
{
    ...
    bool night_map_enabled_ = false;
    bool normal_map_enabled_ = false;


    QVector<std::shared_ptr<textured_plane>> planes;
    size_t count = 1;
