...
class textured_plane final: public renderable
{
...
public:
    textured_plane(const QColor& color = {255,255,255 }, size_t count = 1, const QVector3D& position = {0,0,0}, const QVector3D& rotation = {1,0,0}, float rotation_angle = 0,
