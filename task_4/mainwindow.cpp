...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent), cube(std::make_unique<CubeWidget>(this)){
    ...
    QObject::connect(ui.checkBox, &QCheckBox::clicked, this, &MainWindow::fshadingChanged);
...
void MainWindow::fshadingChanged() {
    QCheckBox* box = dynamic_cast<QCheckBox*>(sender());
    cube->setFShading(box->isChecked());
}
